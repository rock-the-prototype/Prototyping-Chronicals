...
The [**Agile Innovation Framework (AIF)**](https://github.com/Agile-Innovation/Agile-Innovation-Framework) is an open framework for an agile, iterative prototyping method that drives innovation efficiently and purposefully by seamlessly linking strategy, technical implementation, and operational processes, and defines a transparent, auditable, and secure software development process.
...
This repository is structured according to the [**Agile Innovation Framework (AIF)**](https://github.com/Agile-Innovation/Agile-Innovation-Framework). 
...
[**DSL Core**](https://github.com/rock-the-prototype/dsl-core) provides the formal foundation for defining and validating selected artifacts in a structured and machine-readable way.
